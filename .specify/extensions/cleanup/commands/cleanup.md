...
If FEATURE_DIR/tech-debt-report.md already exists, append new findings under a dated section header (e.g., `## Cleanup Run — 2026-03-02`) rather than overwriting. This preserves prior analysis while keeping a single file.

Create or append to FEATURE_DIR/tech-debt-report.md:
