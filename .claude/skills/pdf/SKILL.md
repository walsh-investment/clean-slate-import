...
- **pypdf** — Merge, split, rotate, encrypt, and basic text extraction (`pip install pypdf`)
- **pdfplumber** — Layout-aware text and table extraction (`pip install pdfplumber`)
- **ReportLab** — Creating new PDFs programmatically (`pip install reportlab`)
- **pytesseract + Poppler** — OCR on scanned PDFs (requires system install of Tesseract and Poppler)
- **qpdf** — Command-line merge and manipulation (system package)
