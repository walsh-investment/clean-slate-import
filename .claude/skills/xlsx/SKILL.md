...
- **pandas** — Data reading, analysis, and writing (`pip install pandas openpyxl`)
- **openpyxl** — Formula-aware Excel read/write (bundled with pandas install above)
- **scripts/recalc.py** — Formula recalculation via LibreOffice (requires LibreOffice installed)
